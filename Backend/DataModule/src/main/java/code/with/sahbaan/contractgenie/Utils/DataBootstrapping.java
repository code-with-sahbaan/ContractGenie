...
public class DataBootstrapping implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        log.info("*** INSERTING EMBEDDING TEMPLATE ***");
        if (appConfigRepository.findByName(Constants.EMBEDDING_SUCCESSFULLY_CREATED_NAME) == null){
            AppConfigs appConfigs = new AppConfigs();
            appConfigs.setName(Constants.EMBEDDING_SUCCESSFULLY_CREATED_NAME);
            appConfigs.setValue(Constants.EMBEDDING_SUCCESSFULLY_CREATED_TEMPLATE);
            appConfigRepository.save(appConfigs);
        }
